...
⠀⠀⠀⠀⠀⠀⢀⣤⣶⣶⣖⣦⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⢀⣾⡟⣉⣽⣿⢿⡿⣿⣿⣆⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⢠⣿⣿⣿⡗⠋⠙⡿⣷⢌⣿⣿⠀⠀⠀⠀⠀⠀⠀RIILLYZYXTOOLS ${version}
⣷⣄⣀⣿⣿⣿⣿⣷⣦⣤⣾⣿⣿⣿⡿⠀⠀⠀⠀⠀⠀⠀Owner: RILLYZY DEVELOPER 
⠈⠙⠛⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣧⡀⠀⢀⠀⠀⠀⠀Premium: true
⠀⠀⠀⠸⣿⣿⣿⣿⣿⣿⣿⣿⣿⡟⠻⠿⠿⠋⠀⠀⠀⠀WhatsApp: ?????
⠀⠀⠀⠀⠹⣿⣿⣿⣿⣿⣿⣿⣿⡇⠀⠀⠀⠀⠀⠀⠀ Portable Tools DDoS By RILLYZY
⠀⠀⠀⠀⠀⠈⢿⣿⣿⣿⣿⣿⣿⣇⠀⠀⠀⠀⠀⠀⠀⡄
⠀⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣿⣿⣿⣆⠀⠀⠀⠀⢀⡾⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠻⣿⣿⣿⣿⣷⣶⣴⣾⠏⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⠛⠛⠋⠁⠀⠀⠀⠀
...
async function bootup() {
  try {
    ...
    permen.question('[\x1b[1m\x1b[31mSecurity\x1b[0m]: \n', async (skibidi) => {
      if (skibidi === password.trim()) {
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To RILLXTOLS  ${version}`)
        await sleep(1000)
		    await banner()
...
Type exit To Stop
`);
permen.question('[\x1b[1m\x1b[31mRILLYZY Wifi Killer\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
Created And Coded Full By RILLYZY

Thx To:
RILLYZY DEVELOPER ( DEV )
...
Allah SWT
`
permen.question('[\x1b[1m\x1b[32mRILLYZY Console\x1b[0m]: \n', (input) => {
